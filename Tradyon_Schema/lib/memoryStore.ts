...
class MemoryStore {
  ...
  // Restore company data (used when server memory is lost)
  restoreCompany(companyName: string, companyData: CompanyData): void {
    this.setCompany(companyName, companyData);
  }
}
