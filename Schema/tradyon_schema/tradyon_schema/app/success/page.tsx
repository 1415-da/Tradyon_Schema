...
function SuccessPageContent() {
  ...
  useEffect(() => {
    ...
    if (url) {
      setSheetUrl(url);
      if (jsonPath) setJsonFilePath(jsonPath);
      ...
      // If no sheet URL, redirect to home
      router.push('/');
    }
  }, [searchParams, router]);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-12 text-center border border-gray-100">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Your product specifications have been successfully exported to Google Sheets.
            Each product has been created as a separate sheet with professional formatting.
          </p>

          {/* Google Sheets Link */}
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8 mb-8 shadow-lg">
            <div className="flex items-center justify-center mb-4">
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-md">
                <svg className="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M11.318 12.545H7.91V9.09h3.41v3.455zm0 5.727H7.91v-3.41h3.41v3.41zm5.727-11.318H7.91V3.545h9.136v3.41zm5.727 5.727h-3.41V9.09h3.41v3.455zm0 5.727h-3.41v-3.41h3.41v3.41zM22.955 0H7.91C6.864 0 6 .864 6 1.91v20.18C6 23.136 6.864 24 7.91 24h15.045c1.046 0 1.91-.864 1.91-1.91V1.91C24.864.864 24 .864 23.955 0z"/>
                </svg>
              </div>
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Your Google Sheets File</h3>
            <div className="bg-white rounded-xl p-4 mb-6 border border-gray-200">
              <p className="text-sm text-gray-600 break-all font-mono">{sheetUrl}</p>
            </div>
            <a
              href={sheetUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-lg font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-4 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
          ...
          {jsonFilePath && (
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-200 rounded-2xl p-8 mb-8 shadow-lg">
              <div className="flex items-center justify-center mb-4">
                <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-md">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-4">JSON Export File Created</h3>
              <div className="bg-white rounded-xl p-4 mb-6 border border-gray-200">
                <p className="text-sm text-gray-600 font-mono break-all">{jsonFilePath}</p>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-sm font-medium text-yellow-800">Local Development Only</h4>
                    <p className="text-xs text-yellow-700 mt-1">
                      JSON files are created locally and won't be available in Vercel deployment. Use the Google Sheets export for production.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-700">New Google Sheets file</span>
                </div>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-700">JSON export file</span>
                </div>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-700">Product sheets created</span>
                </div>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-700">Category specifications</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
            ...
            <p className="text-sm text-gray-500">
              Built with modern web technologies for reliable, scalable product management.
            </p>
          </div>
        </div>
      </div>
